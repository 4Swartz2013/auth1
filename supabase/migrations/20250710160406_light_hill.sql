/*
  # Complete Integration Management Database Schema
  ...
  1. New Tables
    ...
    - `integration_webhooks` - Stores webhook configurations
    - `integration_sync_jobs` - Tracks sync jobs for integrations
    - `integration_events` - Stores webhook events
...
-- Add foreign key from credentials to integrations
